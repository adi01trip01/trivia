...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}/{}".format('postgres:adi123@localhost:5432', self.database_name)
    ...
    def test_404_sent_requesting_beyond_valid_page(self):
        ...
        self.assertEqual(data['message'], 'The resource you requested not found')
    ...
    def test_search_question(self):
        search_term = {'searchTerm': 'autobiography'}
